...
EMCC_FLAGS=(
    ...
    -s EXPORTED_FUNCTIONS="[_malloc,_free,_initialize_emulator,_load_rom,_load_rom_chunk_direct,_start_emulation,_stop_emulation,_get_frame_buffer,_read_byte_from_memory,_write_byte_to_memory,_write_bytes_to_memory,_init_rom_loading,_finalize_rom_loading,_get_chunk_buffer,_test_read_function]"
