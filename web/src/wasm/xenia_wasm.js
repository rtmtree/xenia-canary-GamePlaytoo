...
var compilerSettings = {
  ...
  "DEFAULT_LIBRARY_FUNCS_TO_INCLUDE": [ "$ExitStatus", "$PThread", "$addOnPostRun", "$addOnPreRun", "$callRuntimeCallbacks", "$establishStackSpace", "$getValue", "$invokeEntryPoint", "$noExitRuntime", "$ptrToString", "$registerTLSInit", "$setValue", "$stackRestore", "$stackSave", "$warnOnce", "$wasmMemory", "__assert_fail", "__cxa_throw", "_abort_js", "_embind_register_bigint", "_embind_register_bool", "_embind_register_emval", "_embind_register_float", "_embind_register_integer", "_embind_register_memory_view", "_embind_register_std_string", "_embind_register_std_wstring", "_embind_register_void", "_emscripten_init_main_thread_js", "_emscripten_notify_mailbox_postmessage", "_emscripten_receive_on_main_thread_js", "_emscripten_thread_cleanup", "_emscripten_thread_mailbox_await", "_emscripten_thread_set_strongref", "clock_time_get", "emscripten_check_blocking_allowed", "emscripten_exit_with_live_runtime", "emscripten_get_now", "emscripten_resize_heap", "exit", "fd_close", "fd_seek", "fd_write", "$ccall", "$cwrap" ],
